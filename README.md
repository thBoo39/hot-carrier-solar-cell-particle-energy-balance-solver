...
However, in an aspect, it is not realistic because the carrier thermalization is very rapid process, typically in the order of less than pico seconds. If we can find an absorber material with slow cooling, realization of hot carrier solar cells will be possible.

<img src="fig\SBEffEgw400p69.png" width=60%>
